...
class PersonDetailItem extends HookConsumerWidget {
  ...
  Widget _buildDescriptionSection(BuildContext context, WidgetRef ref, person) {
    final physicalTraits = _parseDescriptionTraits(person.physicalDescription);
    final clothingTraits = _parseDescriptionTraits(person.clothingDescription);
  ...
  void _generateDescriptions(WidgetRef ref, person) async {
    try {
      ...
      final updatedPerson = person.copyWith(
        physicalDescription: physicalDesc ?? person.physicalDescription,
        clothingDescription: clothingDesc ?? person.clothingDescription,
      );
  ...
  Widget _autoGenerateDescriptions(WidgetRef ref, dynamic person) {
    ...
    if ((person.physicalDescription == null || person.physicalDescription!.isEmpty) &&
        (person.clothingDescription == null || person.clothingDescription!.isEmpty)) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
  ...
  void _rerollSpecificTrait(WidgetRef ref, dynamic person, String type, int traitIndex) async {
    try {
      ...
      if (type == 'physical') {
        ...
        currentDescription = person.physicalDescription ?? '';
        ...
        currentDescription = person.clothingDescription ?? '';
      ...
      if (newDescription != null && newDescription != currentDescription) {
        ...
        if (newTraits.isNotEmpty && traitIndex < currentTraits.length) {
          ...
          final updatedPerson = type == 'physical'
              ? person.copyWith(physicalDescription: updatedDescription)
              : person.copyWith(clothingDescription: updatedDescription);
  ...
  void _addMoreTraits(WidgetRef ref, dynamic person) async {
    try {
      ...
      final currentPhysical = _parseDescriptionTraits(person.physicalDescription);
      final currentClothing = _parseDescriptionTraits(person.clothingDescription);
  ...
  void _generateInitialDescriptions(WidgetRef ref, dynamic person) async {
    try {
      ...
      if (physicalTemplates.isNotEmpty && (person.physicalDescription == null || person.physicalDescription!.isEmpty)) {
      ...
      if (clothingTemplates.isNotEmpty && (person.clothingDescription == null || person.clothingDescription!.isEmpty)) {
